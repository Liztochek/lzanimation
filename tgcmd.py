...
def betalove(_, msg):
 ...
 @app.on_message(filters.command("my love is polya❤", prefixes=".") & filters.me)
def betalove(_, msg):
    time = 0.6
    for i in range(1):
        msg.edit(f"<b>я</b>")  # red
        ...
        msg.edit(f"<b>я тебя</b>")  # orange
        sleep(time)
        msg.edit(f"<b>я тебя обожаю,</b>")  # orange
        sleep(time)
        msg.edit(f"<b>я тебя обожаю,уважаю,</b>")  # red
        sleep(time)
        msg.edit(f"<b>я тебя обожаю,уважаю,люблю</b>")  # orange
        sleep(time)
        msg.edit(f"<b>я тебя обожаю,уважаю,люблю и</b>")  # red
        sleep(time)
        msg.edit(f"<b>я тебя обожаю,уважаю,люблю и будь как всегда самой лучшей 🥺</b>")  # orange
        sleep(5)
        for i in range(1):
        msg.edit(f"🤍🤍🤍🤍🤍🤍🤍🤍🤍\n🤍🤍❤️❤️🤍❤️❤️🤍🤍\n🤍❤️❤️❤️❤️❤️❤️❤️🤍\n🤍🤍❤️❤️❤️❤️❤️🤍🤍\n🤍🤍🤍❤️❤️❤️🤍🤍🤍\n🤍🤍🤍🤍❤️🤍🤍🤍🤍\n🤍🤍🤍🤍🤍🤍🤍🤍🤍\n")  # red
        sleep(time)
        ...
        msg.edit(f"<b> @Liztochekkkk </b>")
        sleep(time)
        msg.edit(f"<b> Made by @Liztochekkkk and Alice💜💓💗 </b>")
        sleep(time)
        msg.edit(f"<b>⭐ @Liztochekkkk </b>")
